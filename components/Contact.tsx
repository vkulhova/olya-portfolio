        ...
        <div className="flex flex-col w-full sm:w-[51%] bg-white rounded-[6px] px-7 sm:px-12 pt-8 pb-10 sm:pt-12 sm:pb-16">
          ...
          <div className="mt-10 sm:mt-16 flex flex-col items-center">
            <button
              ...
              className="btn-send px-6 h-14 pl-[calc(1.5rem+0.2em)] rounded-[62px] font-chrome font-extrabold text-[16px] tracking-[4px] uppercase transition-colors disabled:opacity-60"
