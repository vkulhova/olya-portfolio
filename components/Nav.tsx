        ...
        <div className="hidden sm:flex gap-6 md:gap-10">
          {LINKS.map((link) => (
            <a
              ...
              className={`font-chrome font-extrabold text-[16px] tracking-[4px] uppercase transition-colors accent-hover ${
            ...
            <div className="flex flex-col items-center gap-6 py-8">
              {LINKS.map((link) => (
                <a
                  ...
                  aria-current={view === link ? "page" : undefined}
                  className={`font-chrome font-extrabold text-[16px] tracking-[4px] uppercase transition-colors ${
                    view === link ? "accent-ink" : "text-dark"
                  }`}
                >
                  {labels[link]}
